CREATE TYPE "public"."notifications_types" AS ENUM('follow', 'review', 'reply', 'mention');--> statement-breakpoint
...
ALTER TABLE "products" ADD CONSTRAINT "products_to_profiles" FOREIGN KEY ("profile_id") REFERENCES "public"."profiles"("profile_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
